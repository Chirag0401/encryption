...
def main():
    ...
    if len(combined_rules) > 195:
        user_choice = input("Rule count exceeds 195. Would ypu like to create a new security group or use an existing one? (new/existing): ").lower()
        ...
        if user_choice == 'new':
            ...
            print("Invalid input. Existing the script.")
    else:
