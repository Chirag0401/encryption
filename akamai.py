...
Index(['IP Address Range', 'IP Version'], dtype='object')
Created new security group sg-01bdc4e308397a905 and added IPs
Created new security group sg-054370d49e4b95911 and added IPs
Traceback (most recent call last):
  File "akamai.py", line 117, in <module>
    main()
  File "akamai.py", line 113, in main
    new_sg_id = create_security_group(vpc_id, "akamai-sg", ips_chunk)
  File "akamai.py", line 67, in create_security_group
    'IpRanges': [{'CidrIp': ip} for ip in ips]
